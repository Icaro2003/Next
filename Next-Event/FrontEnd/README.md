...
```
Usuário → Login.jsx → POST /api/users/login → BackEnd retorna { token, usuario }
                                                      ↓
                                               jwt-decode extrai a role do token
                                                      ↓
                                               Salva token e usuarioLogado no localStorage
                                                      ↓
